      ...
      try {
        ...
        for (const testCase of testCases) {
          ...
          if (passed) {
            ...
            console.log(chalk.dim(`    Expected: ${testCase.expectedCompliant ? 'Compliant' : 'Non-Compliant'}`));
            console.log(chalk.dim(`    Actual: ${result.isCompliant ? 'Compliant' : 'Non-Compliant'}`));
