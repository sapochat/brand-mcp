...
export const ValidationSchemas = {
  ...
  contentEvaluation: z.object({
    content: z.string()
      ...
      .max(SECURITY_CONFIG.maxContentLength, `Content exceeds maximum length of ${SECURITY_CONFIG.maxContentLength} characters`)
...
export class RateLimiter {
  ...
  constructor(maxRequests = SECURITY_CONFIG.rateLimit.maxRequests, windowMs = SECURITY_CONFIG.rateLimit.windowMs) {
 ...
 */
export function wrapError(error: unknown, userMessage: string = 'An error occurred', code: string = 'UNKNOWN_ERROR'): SafeError {
